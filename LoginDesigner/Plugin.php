...
?>
<link rel="stylesheet" href="<?php Helper::options()->pluginUrl(); ?>/LoginDesigner/style.css?202108">
<?php
...
'bgfengge', array(
  ...
  'bilibili' => _t('<div class="kuai"><img src="'.$url.'/images/bilibili.jpg" loading="lazy">'.$zz10.'</div>'),
...
if($skin=='heike'){
$hed=$hed. '<link rel="stylesheet" href="'.$url.'skin/'.$skin.'.css?2021">';
}else{
...
$hed=$hed. '<link rel="stylesheet" href="'.$url.'skin/'.$skin.'.css?2021">'.$zidingyi;
}
}
...
elseif($skin=='bilibili'){
$ft='<script type="text/javascript">
            $(function(){
            $(\'.typecho-login h1\').replaceWith(\'<div id="l23"></div><div id="r23"></div>\');
                ...
                confirm.bind(\'focus\', function(){
                    ...
                    l23.css(\'background-image\', \'url('.$url.'img/222.png)\');
                    r23.css(\'background-image\', \'url('.$url.'img/333.png)\');
                });
                confirm.blur(function(){
                    l23.css(\'background-image\', \'url('.$url.'img/22.png)\');
