...
?>
<link rel="stylesheet" href="<?php Helper::options()->pluginUrl(); ?>/LoginDesigner/style.css?20191122">
<?php
...
$zz4='<div class="zz">黑客帝国<br>作者：<a href="http://qqdie.com" target="_blank">泽泽社长</a></div>';
$zz5='<div class="zz">纯白<br>作者：<a href="http://qqdie.com" target="_blank">泽泽社长</a></div>';    
...
'bgfengge', array(
  ...
  'heike' => _t('<div class="kuai tags"><img src="'.$url.'/images/heike.jpg" loading="lazy">'.$zz4.'</div>'),
  'bai' => _t('<div class="kuai"><img src="'.$url.'/images/bai.jpg" loading="lazy">'.$zz5.'</div>'),
...
$zidingyi="";
if($bgUrl){
  $zidingyi="<style>body{background: url(".$bgUrl.")}</style>";
}
$hed=$hed. '<link rel="stylesheet" href="'.$url.'skin/'.$skin.'.css">'.$zidingyi;
}
